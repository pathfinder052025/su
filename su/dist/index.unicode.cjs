...
const su         = require('../dist/index.base.cjs');
const unic       = __filename.readSign();
const {O1,O2,O6} = su;

const {A1,A2,A3,A4,A5,A6,A7,A8,C1,C2,C3,C4,C5,C6,L1,L2,L3,N1,N2,N3,N4,N5,N6,N7,N8,a1,a2,a3,a4,a5,a6,a7,a8,g,V1,V2,V3} = unic.CONFIG.unicode;
...
const sFace        = {C1,C2,C3,C4,C5,C6}
const sAlphaLower  = {a1,a2,a3,a4,a5,a6,a7,a8};
const sArrow       = {V1,V2,V3};
const sGreek       = {g}

var vdata = [];
var data  = {latin:sLatin, number:sNumber, letter:sLetter, face:sFace, alpha:sAlphaUpper, betha:sAlphaLower, array:sArrow, greek:sGreek};
